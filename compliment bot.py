...
def female_voice(comments):
    ...
    mynewvoice = 160
    mytext.setProperty('rate',mynewvoice)
    mytext.say(comments)
    mytext.runAndWait()
    return temp


def male_voice(comments):
    temp = ""
    mytext = pyttsx3.init()
    voices = mytext.getProperty('voices')
    mynewvoice = 160
...
while(True):
    if gender == 'F' or gender == "M" or gender == 'f' or gender == 'm':
        break
    else:
...
if gender == 'F' or gender =="f": heshe = 'She' ; himher = 'Her' ; guygirl = 'girl' ; hisher = 'her'; girlguy = "girl"; 
elif gender == 'M' or gender =="m": heshe = 'He' ; himher = 'Him' ; guygirl = 'boy'; hisher = 'his'; girlguy = "girl"; 
